        ...
        <div class="col-12 col-lg-5 col-md-10 col-sm-12 mt-3">
            <div class="card border-0">
                <div class="card-body shadow rounded" style="padding-top: 34px; padding-bottom: 30px;">
                    ...
                    <input type="button" value="Buy" class="btn btn-success py-1 px-5 text-success me-2 rounded-pill"
                        style="background: none;">
                    <input type="button" value="Sell" class="btn btn-danger py-1 px-5 text-danger ms-2 rounded-pill"
                        style="background: none;">
                </div>
            </div>
        </div>
